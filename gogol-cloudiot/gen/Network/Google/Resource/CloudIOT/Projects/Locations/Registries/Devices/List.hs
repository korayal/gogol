...
data ProjectsLocationsRegistriesDevicesList = ProjectsLocationsRegistriesDevicesList'
    { _plrdlParent                                  :: !Text
    ...
    , _plrdlFieldMask                               :: !(Maybe FieldMask)
...
plrdlFieldMask :: Lens' ProjectsLocationsRegistriesDevicesList (Maybe FieldMask)
plrdlFieldMask
...
instance GoogleRequest
         ProjectsLocationsRegistriesDevicesList where
