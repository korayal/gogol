...
-- |
-- Module      : Network.Google.ServiceUser.Types.Product
...
--
module Network.Google.ServiceUser.Types.Product where
...
--
-- /See:/ 'listEnabledServicesResponse' smart constructor.
data ListEnabledServicesResponse = ListEnabledServicesResponse'
    { _lesrNextPageToken :: !(Maybe Text)
    , _lesrServices      :: !(Maybe [PublishedService])
    } deriving (Eq,Show,Data,Typeable,Generic)
...
listEnabledServicesResponse =
    ListEnabledServicesResponse'
    { _lesrNextPageToken = Nothing
    , _lesrServices = Nothing
    }
...
lesrNextPageToken
  = lens _lesrNextPageToken
      (\ s a -> s{_lesrNextPageToken = a})

-- | Services enabled for the specified parent.
lesrServices :: Lens' ListEnabledServicesResponse [PublishedService]
lesrServices
  = lens _lesrServices (\ s a -> s{_lesrServices = a})
      . _Default
      . _Coerce

instance FromJSON ListEnabledServicesResponse where
        parseJSON
          = withObject "ListEnabledServicesResponse"
              (\ o ->
                 ListEnabledServicesResponse' <$>
                   (o .:? "nextPageToken") <*>
                     (o .:? "services" .!= mempty))

instance ToJSON ListEnabledServicesResponse where
        toJSON ListEnabledServicesResponse'{..}
          = object
              (catMaybes
                 [("nextPageToken" .=) <$> _lesrNextPageToken,
                  ("services" .=) <$> _lesrServices])
...
-- Management.
--
-- /See:/ 'publishedService' smart constructor.
data PublishedService = PublishedService'
    { _psService :: !(Maybe Service)
    , _psName    :: !(Maybe Text)
    } deriving (Eq,Show,Data,Typeable,Generic)
...
instance FromJSON PublishedService where
        parseJSON
          = withObject "PublishedService"
              (\ o ->
                 PublishedService' <$>
                   (o .:? "service") <*> (o .:? "name"))

instance ToJSON PublishedService where
...
--
-- /See:/ 'searchServicesResponse' smart constructor.
data SearchServicesResponse = SearchServicesResponse'
    { _ssrNextPageToken :: !(Maybe Text)
    , _ssrServices      :: !(Maybe [PublishedService])
    } deriving (Eq,Show,Data,Typeable,Generic)
...
searchServicesResponse =
    SearchServicesResponse'
    { _ssrNextPageToken = Nothing
    , _ssrServices = Nothing
    }
...
ssrNextPageToken
  = lens _ssrNextPageToken
      (\ s a -> s{_ssrNextPageToken = a})
...
ssrServices
  = lens _ssrServices (\ s a -> s{_ssrServices = a}) .
      _Default
      . _Coerce

instance FromJSON SearchServicesResponse where
        parseJSON
          = withObject "SearchServicesResponse"
              (\ o ->
                 SearchServicesResponse' <$>
                   (o .:? "nextPageToken") <*>
                     (o .:? "services" .!= mempty))

instance ToJSON SearchServicesResponse where
        toJSON SearchServicesResponse'{..}
          = object
              (catMaybes
                 [("nextPageToken" .=) <$> _ssrNextPageToken,
                  ("services" .=) <$> _ssrServices])
